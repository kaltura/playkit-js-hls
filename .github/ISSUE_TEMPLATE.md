...
##### Prerequisites
- [ ] Have you checked for duplicate [issues](https://github.com/kaltura/playkit-js-hls/issues): ______
- [ ] Which Plugin [version](https://github.com/kaltura/playkit-js-hls/releases) are you using: ______
